  ...
  export function CardSkeleton() {
    return (
      <div className="animate-pulse">
        {/* Desktop view */}
      <div className="hidden md:flex flex-col md:flex-row items-center md:items-start rounded-lg overflow-hidden bg-white shadow-md p-6 mb-8 ">
        ...
        {/* Mobile view */}
      <div className="flex flex-col items-center rounded-lg overflow-hidden bg-white shadow-md p-6 mb-8 md:hidden">
        {/* Image on top for mobile view */}
        <div className="w-full mb-4">
          <div className="bg-gray-300 h-48 w-full"></div>
        </div>

        {/* Title, Details, and Apply Link below for mobile view */}
        <div className="w-full">
          <h2 className="text-2xl font-bold mb-4 bg-gray-300 h-6 w-full"></h2>
          <p className="text-gray-700 mb-4 bg-gray-300 h-4 w-full"></p>
          <div className="text-blue-500 hover:underline bg-gray-300 h-6 w-1/4"></div>
        </div>
      </div>
